...
<body>
    ...
    <div class="container-fluid page-header py-5 mb-5">
        <div class="container py-5">
            <h1 class="display-3 text-white mb-3 animated slideInDown">Produk Hukum</h1>
            <nav aria-label="breadcrumb animated slideInDown">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item text-white active" aria-current="page">Produk Hukum</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <div class="container-fluid mt-3">
        <div class="p-4 bg-white border rounded shadow-sm">
            ...
            <h4 class="text-primary mb-4">Daftar Dokumen Produk Hukum</h4>

            <div class="row">
                <?php while ($row = mysqli_fetch_assoc($query)) :
                    $nama_dokumen = htmlspecialchars($row['nama_dokumen']);
                    $file = '../assets/file/produk_hukum/' . $row['dokumen'];
                    ...
                    <div class="col-md-6 col-lg-4 mb-4">
                        <div class="card shadow-sm h-100 border">
                            ...
                            <div class="card-body">
                                ...
                                <p class="mb-3"><strong>Tahun:</strong> <?= $tahun ?></p>
                ...
                <?php if (mysqli_num_rows($query) == 0): ?>
                    <div class="col-12">
                        <div class="alert alert-info text-center">
                            Tidak ada dokumen produk hukum yang tersedia saat ini.
                        </div>
                    </div>
                <?php endif; ?>
